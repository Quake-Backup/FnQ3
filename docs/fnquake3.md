...
<li><b>\r_hdr</b> <font color=silver>-1|<b>0</b>|1</font> - select the scene-linear HDR render pipeline: 0 keeps the display-referred SDR compatibility path, 1 enables scene-linear exposure, bloom thresholding, tone mapping, and output transform state, and -1 remains a legacy debug alias for <b>\r_hdrPrecision -1</b>.</li>
