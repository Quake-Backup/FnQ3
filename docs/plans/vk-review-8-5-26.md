# Vulkan Renderer Review for FnQ3 in the idtech3 Context
...
| OS/library/surface binding | `code/win32/win_qvk.c`, `code/unix/linux_qvk.c` | Functional, but Linux support visible in the retrieved code is Xlib-only. |
