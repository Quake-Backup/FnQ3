...
ROADMAP = ROOT / "docs" / "fnquake3" / "DLIGHT_SHADOWMAP_ROADMAP.md"
...
def check_roadmap(failures: list[str]) -> None:
    ...
    require(artifacts, "vk-modern-dlight-shadows-surfacelight-large-planar-q3dm6-vulkan", "Vulkan baseline key", failures)
...
def check_combined_atlas_roadmap(failures: list[str]) -> None:
    ...
    require(artifacts, "vk-modern-dlight-shadows-combined-shadow-atlas-q3dm6-vulkan", "Vulkan baseline key", failures)
...
def check_csm_fallback_roadmap(failures: list[str]) -> None:
    ...
    require(artifacts, "vk-modern-dlight-shadows-csm-fallback-no-world-q3dm17-vulkan", "Vulkan baseline key", failures)
