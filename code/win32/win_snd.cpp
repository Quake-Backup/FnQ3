...
static int			inPlay;
static fnq3::win::ScopedHandle hEvent;
static fnq3::win::ScopedHandle hThread;
...
static fnq3::win::ScopedCoTaskMem<WCHAR> DeviceID;
static qboolean doSndRestart = qfalse;

static fnq3::win::ScopedComPtr<IAudioRenderClient> iAudioRenderClient;
static fnq3::win::ScopedComPtr<IAudioClient> iAudioClient;
static fnq3::win::ScopedComPtr<IMMDeviceEnumerator> pEnumerator;
static fnq3::win::ScopedComPtr<IMMDevice> iMMDevice;
...
static DWORD WINAPI ThreadProc( LPVOID initEvent )
{
	...
	fnq3::win::ScopedLibrary avrtLibrary( LoadLibraryW( L"avrt" ) );
...
static qboolean SNDDMA_InitWASAPI( void )
{
	...
	fnq3::win::ScopedCoTaskMem<WAVEFORMATEX> closest;
	DWORD					dwThreadID;
	fnq3::win::ScopedHandle	hInited;
	qboolean				isfloat;
	HRESULT					hr;
...
static fnq3::win::ScopedComPtr<IDirectSound> pDS;
static fnq3::win::ScopedComPtr<IDirectSoundBuffer> pDSBuf;
static fnq3::win::ScopedComPtr<IDirectSoundBuffer> pDSPBuf;
static fnq3::win::ScopedComInitialization s_soundCom;
