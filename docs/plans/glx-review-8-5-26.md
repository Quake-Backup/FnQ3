...
flowchart LR
    ...
    B --> C[GLx module target<br/>fnquake3_glx_<arch>]
...
| User-facing docs | `docs/fnquake3/GLX_RENDERER.md`, `docs/DISPLAY.md`, `BUILD.md` | Architecture note, experimental status, build usage, display/bloom guidance |
