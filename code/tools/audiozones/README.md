...
.tmp/cmake-check/fnq3-audiozonesc.exe --from-bsp --material-map docs/audio-materials.txt -o baseq3/maps/q3dm17.azb baseq3/maps/q3dm17.bsp
...
python scripts/audio_zone_sweep.py `
  --tool .tmp/cmake-check/Release/fnq3-audiozonesc.exe `
