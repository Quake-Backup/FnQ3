...
def check_source(label: str, root: str, failures: list[str]) -> None:
    ...
    require(header, "shadowManager_t\tshadowManagerDebug;", f"{label} backend world-manager debug snapshot", failures)
    ...
    require(backend, "backEnd.shadowManagerDebug = tr.shadowManager;", f"{label} world-manager debug snapshot capture", failures)
    ...
    require(cmds, "tr.shadowManager = backEnd.shadowManagerDebug;", f"{label} world-manager debug snapshot restore", failures)
