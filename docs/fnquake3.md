...
<li><b>\r_hdr</b> <font color=silver>-1|<b>0</b>|1</font> - select the HDR-capable FBO render pipeline: 0 keeps the display-referred SDR compatibility path, 1 uses high-precision FBO storage while legacy tone mapping preserves Quake III lighting, and -1 remains a legacy debug alias for <b>\r_hdrPrecision -1</b>.</li>
<li><b>\r_hdrPrecision</b> <font color=silver>-1|<b>0</b>|8|16</font> - select internal FBO color storage independently from HDR semantics: 0 automatic, -1 debug 4-bit storage, 8 force 8-bit SDR storage, 16 force 16-bit normalized SDR storage; <b>\r_hdr 1</b> always uses <b>RGBA16F</b> floating-point scene storage.</li>
<li><b>\r_hdrBloomFormat</b> <font color=silver><b>0</b>|1|2|3</font> - select HDR bloom/extract intermediate storage without changing the main scene target: 0 automatic compact positive RGB bloom with RGBA16F fallback, 1 force RGBA16F, 2 prefer R11G11B10F, 3 reserve RG16F for positive two-channel intermediates.</li>
<li><b>\r_tonemap</b> <font color=silver><b>0</b>|1|2</font> - final-pass tone mapper for <b>\r_hdr 1</b>: 0 legacy gamma/overbright, 1 Reinhard, 2 ACES fitted filmic curve.</li>
<li><b>\r_tonemapExposure</b> <font color=silver>0.1..8.0</font> - exposure multiplier used by scene-linear tone mapping and bloom extraction.</li>
<li><b>\r_colorGrade</b> <font color=silver><b>0</b>|1|2|3</font> - scene-linear color grading for <b>\r_hdr 1</b>: 0 disabled, 1 lift/gamma/gain plus white-point adaptation, 2 3D LUT atlas, 3 both. Defaults are identity and demo-safe.</li>
<li><b>\r_colorGradeLift</b>, <b>\r_colorGradeGamma</b>, <b>\r_colorGradeGain</b> - per-channel grading controls as <b>"r g b"</b>; defaults are <b>"0 0 0"</b>, <b>"1 1 1"</b>, and <b>"1 1 1"</b>.</li>
<li><b>\r_colorGradeWhitePoint</b>, <b>\r_colorGradeAdaptWhitePoint</b> <font color=silver>1000..40000</font> - source and target white points in Kelvin for Bradford adaptation; both default to D65-ish <b>6504</b>.</li>
<li><b>\r_colorGradeLUT</b>, <b>\r_colorGradeLUTScale</b> - optional 3D LUT atlas path and scene-linear range. LUT atlases use width <b>N*N</b>, height <b>N</b>, with blue slices laid out horizontally.</li>
...
<li><b>\r_picmipFilter</b> <font color=silver>0..15, default <b>1</b></font> - filter shader paths allowed to use picmip: 0 legacy/all, 1 textures/*, 2 models/*, 4 sprites/*, 8 gfx/icons/menu/ui/fonts; add values to combine</li>
