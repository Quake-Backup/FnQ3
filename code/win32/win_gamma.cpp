...
static fnq3::win::ScopedDisplayDC GLW_OpenGammaDC( void )
{
	if ( glw_state.displayName[0] )
	{
		return fnq3::win::ScopedDisplayDC::ForDisplay( glw_state.displayName );
	}

	return fnq3::win::ScopedDisplayDC::ForDesktop();
}
...
static BOOL IsCurrentSessionRemoteable( void )
{
	...
	else
	{
		...
		fnq3::win::ScopedRegistryKey hRegKey;
		LONG lResult;
