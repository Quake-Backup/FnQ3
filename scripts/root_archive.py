...
DEFAULT_WEAPON_SOUND_SHADER_ASSETS = [
    (
        PKG_ROOT / "baseq3" / "sound" / "fnq3-weapon-sounds.sndshd",
        Path("baseq3") / "sound" / "fnq3-weapon-sounds.sndshd",
    ),
    (
        PKG_ROOT / "missionpack" / "sound" / "fnq3-weapon-sounds.sndshd",
        Path("missionpack") / "sound" / "fnq3-weapon-sounds.sndshd",
    ),
]
