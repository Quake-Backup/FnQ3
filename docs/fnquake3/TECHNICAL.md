...
- [`docs/fnquake3/GLX_VISUAL_DOSSIER.md`](./GLX_VISUAL_DOSSIER.md) defines the generated review dossier written beside every GLx sweep manifest, including pipeline flowcharts, backend-state overlays, histograms, false-color sidecars, parity diffs, and driver-tier matrices.
- [`docs/fnquake3/GLX_PROMOTION.md`](./GLX_PROMOTION.md) defines the default-renderer promotion, migration-alias, legacy-OpenGL2, and rollback package policy. [`docs/fnquake3/GLX_ROLLBACK_PACKAGE.md`](./GLX_ROLLBACK_PACKAGE.md) defines the reviewed JSON metadata required for a promoted release rollback package. [`scripts/glx_promotion.py`](../../scripts/glx_promotion.py) is the machine-readable guard for that policy.
